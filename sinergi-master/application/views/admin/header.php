            ...
            <ul class="dropdown-menu">
			 ...
			 echo base_url()?>assets/images/<?php echo $pp; ?>" class="img-circle" alt="User Image">
              ...
              <li class="user-footer">
               <div class="pull-left">
                  <a href="<?php echo base_url()?>index.php/admin/user/rbh" class="btn btn-default btn-flat primary">Rubah Password</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo base_url()?>index.php/admin/dashboard/logout" class="btn btn-default btn-flat primary">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
